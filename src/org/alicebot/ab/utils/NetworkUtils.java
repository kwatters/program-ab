...
public class NetworkUtils {
   ...
   * milliseconds until a connection is established. // The default value is
   * zero, that means the timeout is not used. int timeoutConnection = 3000;
   ...
   * 5000; HttpConnectionParams.setSoTimeout(httpParameters, timeoutSocket);
   * 
   * 
