...
public class Inflector {
  ...
  public String humanize(String lowerCaseAndUnderscoredWords, String... removableTokens) {
    ...
    result = result.replaceAll("_+", " "); // replace all adjacent underscores
                                           // with a single space
  ...
  public String titleCase(String words, String... removableTokens) {
    ...
    result = replaceAllWithUppercase(result, "\\b([a-z])", 1); // change first
                                                               // char of each
                                                               // word to
                                                               // uppercase
    return result;
   ...
   * in the replacement string to uppercase or lowercase the backreferences. For
  ...
  protected void initialize() {
    ...
    inflect.addSingularize("(s|si|u)s$", "$1s"); // '-us' and '-ss' are already
                                                 // singular
    ...
    inflect.addSingularize("(^analy)sis$", "$1sis"); // already singular, but
                                                     // ends in 's'
    ...
    inflect.addSingularize("(cris|ax|test)is$", "$1is"); // already singular,
                                                         // but ends in 's'
    inflect.addSingularize("(cris|ax|test)es$", "$1is");
    inflect.addSingularize("(octop|vir)i$", "$1us");
    inflect.addSingularize("(octop|vir)us$", "$1us"); // already singular, but
                                                      // ends in 's'
    inflect.addSingularize("(alias|status)es$", "$1");
    inflect.addSingularize("(alias|status)$", "$1"); // already singular, but
                                                     // ends in 's'
