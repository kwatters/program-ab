...
public class Sraix implements SraixHandler {
  ...
  public static String pandorabotsRequest(String input, String host, String botid) {
    try {
       ...
       * "botid="+botid+"&custid="+custid+"&input="+input; String fragment =
       * null; URI uri=null; String out; try { uri = new URI(scheme, authority,
  ...
  public static String sraixPannous(String input, String hint, Chat chatSession, Locale locale) {
    try {
      ...
      String url = "http://ask.pannous.com/api?input=" + input + "&locale=en_US&timeZone=" + offset + locationString + "&login=" + MagicStrings.pannous_login + "&ip="
      ...
      if (page == null || page.length() == 0) {
        ...
        if (outputJson.length() == 0) {
          ...
          if (actions.has("reminder")) {
            // MagicBooleans.trace("in Sraix.sraixPannous, found reminder
            // action");
            ...
            // MagicBooleans.trace("in Sraix.sraixPannous, obj class: " +
            // obj.getClass());
            // MagicBooleans.trace("in Sraix.sraixPannous, obj instanceof
