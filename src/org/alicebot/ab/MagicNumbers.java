...
public class MagicNumbers {
  public static int node_activation_cnt = 4; // minimum number of activations to
                                             // suggest atomic pattern
  public static int node_size = 4; // minimum number of branches to suggest
                                   // wildcard pattern
  public static int displayed_input_sample_size = 6;
  public static int max_history = 32;
  public static int repetition_count = 3;
  ...
  public static int brain_print_size = 100; // largest size of brain to print to
                                            // System.out
}
